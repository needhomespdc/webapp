...
//       <div>
//         <h1 className="text-2xl font-bold text-foreground">Resale Marketplace</h1>
//         <p className="text-foreground/50 text-sm mt-1">List your investment units for resale to other investors.</p>
//       </div>
...
//             <div className="space-y-3 mt-4">
//               {resales.map((listing) => (
//                 <div key={listing.id} className="bg-foreground/5 border border-foreground/10 rounded-2xl p-4">
...
//                       <p className="text-foreground">{listing.quantity} units</p>
//                     </div>
//                     <div>
//                       <p className="text-foreground/40">Price Range</p>
//                       <p className="text-foreground">{formatCurrency(listing.minPricePerUnit)} - {formatCurrency(listing.maxPricePerUnit)}</p>
//                     </div>
//                     <div>
//                       <p className="text-foreground/40">Listed</p>
//                       <p className="text-foreground">{formatDate(listing.createdAt)}</p>
//                     </div>
//                   </div>
