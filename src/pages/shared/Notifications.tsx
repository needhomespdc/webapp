...
//           <p className="text-foreground/50 text-sm mt-1">Stay up to date with your account activity.</p>
//         </div>
...
//                     n.isRead ? 'bg-foreground/10 text-foreground/40' : 'bg-accent/15 text-accent'
//                   )}>
...
//                     </div>
//                     <p className="text-foreground/50 text-sm mt-0.5">{n.body}</p>
